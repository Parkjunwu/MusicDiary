...
import LogOutBtn from "./profile_CustomDrawerContent/LogOutBtn";
...
type ThisNavigationProp = NativeStackNavigationProp<ProfileListTabStackParamsList>;

const Profile_CustomDrawerContent = ({
...
export default Profile_CustomDrawerContent;
