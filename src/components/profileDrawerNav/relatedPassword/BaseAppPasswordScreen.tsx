...
import UploadHorizontalEmptyLayoutForBigScreenNeedScreenWidth from "../../upload/UploadHorizontalEmptyLayoutForBigScreenNeedScreenWidth";
import PasswordInput from "./PasswordInput";
import useBottomTabGetHeaderHeightAndInnerLayout from "../../../hooks/useBottomTabGetHeaderHeightAndInnerLayout";

const Container = styled.View<{minHeightForBigScreen:number}>`
  flex: 1;
  /* background-color: red; */
  min-height: ${({minHeightForBigScreen})=>minHeightForBigScreen}px;
...
const BaseAppPasswordScreen = ({
  ...
  const {innerLayoutHeight:minHeightForBigScreen} = useBottomTabGetHeaderHeightAndInnerLayout();

  return (
    <UploadHorizontalEmptyLayoutForBigScreenNeedScreenWidth>
      <Container minHeightForBigScreen={minHeightForBigScreen}>
        <WarningContainer>
