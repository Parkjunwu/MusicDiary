...
// https://github.com/shahen94/react-native-switch/blob/master/lib/Switch.js

export class SwitchWithText extends Component {
  static propTypes = {
  ...
  static defaultProps = {
    ...
    circleBorderActiveColor: "rgb(150, 150, 150)",
        ...
        >
          ...
          >
            {value && renderActiveText && (
              <FontAppliedBaseTextNeedFontSize style={[styles.text, styles.paddingRight, activeTextStyle]}>
                {activeText}
