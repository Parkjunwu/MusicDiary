...
const DiaryImageWithRealHeight = ({uri,fileWidth,imageStyle,thumbNail}:{uri:string,fileWidth:number,imageStyle?:ImageStyle,thumbNail?:string}) => {
  ...
  return (
    ...
    >
      <Image
        ...
        onLoad={({nativeEvent: {source: {width, height}}}) => setImageHeight(fileWidth * height / width)}
      />
...
export default DiaryImageWithRealHeight;