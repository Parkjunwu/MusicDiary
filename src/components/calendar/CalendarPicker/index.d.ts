...
export interface CalendarPickerProps {
    ...
    onDateChange?: DateDateChangedCallback | undefined;
    ...
    dateParamsObject?: object | undefined;
}
...
export type DateDateChangedCallback = (date: number, type: 'START_DATE' | 'END_DATE') => void;
