// https://github.com/rheng001/react-native-wheel-scrollview-picker 에서 가져옴. 근데 ScrollView 끝나는게 너무 느려서 decelerationRate='fast' 추가함.
  ...
  return (
    <View style={wrapperStyle}>
      <View
        ...
        renderToHardwareTextureAndroid={true} // 크래시 위한 애
      />
      <CustomScrollViewComponent
        // style={isAndroid ? { opacity: 0.99, overflow: 'hidden', } : undefined } // 크래시 위한 애
        style={isAndroid ? { opacity: 0.99 } : undefined } // overflow 넣으면 안됨
        ref={sView}
        bounces={false}
