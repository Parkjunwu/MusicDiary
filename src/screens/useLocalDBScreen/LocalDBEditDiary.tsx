...
type LocalDBEditDiaryProps = NativeStackScreenProps<MyDiaryListTabStackParamsList,"EditDiary">;

// UI 는 UploadDiary, 로직은 EditDiary 랑 거의 비슷

const LocalDBEditDiary = ({navigation,route}:LocalDBEditDiaryProps) => {
  ...
  // const prevYoutubeId = useRef(routeParams.youtubeId ?? undefined).current;
  const prevYoutubeId = useRef(routeParams.youtubeId ?? null).current;
...
export default LocalDBEditDiary;