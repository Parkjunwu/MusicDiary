...
const useGetWidthDealWithBigScreenNeedImageHorizontalEmptySpaceBase20: useGetWidthDealWithBigScreenType = (imageHorizontalEmptySpace = 20) =>{
...
export default useGetWidthDealWithBigScreenNeedImageHorizontalEmptySpaceBase20;
...
const getWidthDealWithBigScreen: getWidthDealWithBigScreenType = (windowWidth, imageHorizontalEmptySpace) => {
  const layoutWidth = Math.min(windowWidth,MAX_WIDTH);
  return {
    layoutWidth,
    imageWidth: layoutWidth - imageHorizontalEmptySpace,
  };
};